package com.dsankovsky.weatherapp.presentation.details
...
import com.dsankovsky.weatherapp.domain.usecases.ChangeFavouriteStateUseCase
import com.dsankovsky.weatherapp.domain.usecases.GetForecastUseCase
import com.dsankovsky.weatherapp.domain.usecases.ObserveFavouriteStateUseCase
import com.dsankovsky.weatherapp.presentation.details.DetailsStore.Intent
import com.dsankovsky.weatherapp.presentation.details.DetailsStore.Label
import com.dsankovsky.weatherapp.presentation.details.DetailsStore.State
    ...
    private inner class BootstrapperImpl(private val city: City) : CoroutineBootstrapper<Action>() {
        override fun invoke() {
            ...
            scope.launch {
                ...
                try {
                    val forecast = forecastUseCase(city.id)
